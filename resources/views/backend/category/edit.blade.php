        ...
        <div class="col-md-offset-3 col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border text-center">
              <h3 class="box-title text-primary ">Update Category</h3>
            </div>
            <!-- /.box-header -->
            ...
            <form role="form" action="{{ url('category/update') }}" method="POST">
              ...
              <div class="box-body">
                <div class="form-group has-success">
                  ...
                  <input type="text" class="form-control" id="name" name="categoryName" value="{{$categoryById->categoryName}}">
                 <input type="hidden" class="form-control form-control-lg" id="name" value="{{$categoryById->id}}" name="categoryId">
                </div>
                ...
                <div class="form-group has-success {{ $errors->has('categoryDescription') ? ' has-error' : 'has-success' }}">
                  ...
                  <textarea type="text" class="form-control" id="name" name="categoryDescription">{{$categoryById->categoryDescription}}</textarea>
